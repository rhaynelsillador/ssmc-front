...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/ssmc-front/WebContent/WEB-INF/apps/pages/about.jsp">
    <%@ include file="commons/CorporateHeader.jsp"%>
    <section id="about" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/ssmc-front/WebContent/WEB-INF/apps/pages/about.jsp">
