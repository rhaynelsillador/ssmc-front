...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-14" data-genuitec-path="/ssmc-front/WebContent/WEB-INF/apps/pages/corporate.old.jsp">
    <header data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-14" data-genuitec-path="/ssmc-front/WebContent/WEB-INF/apps/pages/corporate.old.jsp">
            ...
            <div class="col-md-8 col-md-offset-2">
              <div class="contact-box">
                ...
                <form class="contact-form">
                  <div class="row">
                    <div class="col-md-6">
                      <input type="text" class="form-control" name="" value="" placeholder="Full name">
