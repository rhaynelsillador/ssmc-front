  ...
  <div class="container">
    ...
    <div class="col-md-4 col-sm-3">
      <ul  class="nav nav-pills nav-service wow fadeInRightBig">
        ...
        <li class="hidden">
          <a href="#service_4_2" data-toggle="tab" class="service-left" id="service4_2">
            <aside></aside>
            <h5></h5>
            <span></span>
          </a>
    ...
    <div class="col-md-4 col-sm-3">
      <ul  class="nav nav-pills nav-service wow fadeInLeftBig">
      	<li class="hidden">
          <a href="#service_1_2" data-toggle="tab" class="service-right" id="service1_2">
            <aside></aside>
            <h5></h5>
            <span></span>
          </a>
        ...
        <li class="hidden">
          <a href="#service_3_2" data-toggle="tab" class="service-right" id="service3_2">
            <aside></aside>
            <h5></h5>
            <span></span>
          </a>
    ...
    <div class="text-center">
      <a href="Medical-Services" class="btn btn-primary">MORE SERVICES</a>
    </div>
  </div>
</div>
